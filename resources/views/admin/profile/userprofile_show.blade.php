                ...
                <div class="card-body my-4">
                    <div class="row">
                        <div class="col-3 offset-1 ">
                            <img src="{{ asset(Auth::user()->image == null ?'admin/img/undraw_posting_photo.svg' :"profile/img/example.svg") }}" class="img-thumbnail my-4">
                        </div>
                        <div class="col offset-1">
                            ...
                            <a href="{{ route("password#show") }}" class="btn btn-sm btn-warning my-3 mr-1">Change Password</a>
                            <a href="{{ route("password#show") }}" class="btn btn-sm btn-danger my-3 mr-1">Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>
