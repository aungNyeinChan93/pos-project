        ...
        <div class="row my-2">
            <div class="col-8 offset-2">
               <div class="div p-2 rounded shadow-sm">
                <form action="{{ route("product#create") }}" method="POST" enctype="multipart/form-data" class="p-2">
                    @csrf
                    <div class="mb-3 text-center">
                        <img
                        src="{{ asset("/products/profile.jfif") }}" alt="test"
                        id="output"
                    ...
                    <div class="mb-1">
                        ...
                        <a href="{{ route("adminHome") }}" class="btn btn-sm btn-secondary "> Back</a>
                    </div>
