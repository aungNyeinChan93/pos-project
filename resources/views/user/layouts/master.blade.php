        ...
        <div class="container px-2">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="{{ route('userHome') }}" class="navbar-brand">
                    <h1 class="text-primary display-6">POS PROJECT</h1>
                </a>
                    ...
                    <div class="d-flex m-3 me-0">
                        <a href="{{ route('userProduct#cartPage') }}" class="position-relative me-4 my-auto">
                            ...
                            @if (session('count_Cart') > 0)
                                <span
                                    ...
                                    style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ session('count_Cart') }}</span>
                            @endif
                        </a>
                        <a href="{{ route('payment#orderList') }}" class="position-relative me-4 my-auto">
                            ...
                            @if (count(session('pending_order')) > 0)
                                <span
                                    class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1"
                                    style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ count(session('pending_order')) }}</span>
                            @endif
                        </a>
                        <a href="#" class="my-auto">
                            <span class="text-danger fs-6 fw-lighter ">{{ Auth::user()->name }}</span>
                            <div class="nav-item dropdown">
                                <a href="{{ route('userHome') }}" class="nav-link dropdown-toggle"
