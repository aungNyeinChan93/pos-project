                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="{{ route("userHome") }}" class="nav-item nav-link">Product</a>
                        ...
                        <div class="d-flex m-3 me-0">
                            <a href="{{ route("userProduct#cartPage") }}" class="position-relative me-4 my-auto">
                                ...
                                @if(session("count_Cart") > 0)
                                    <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ session("count_Cart") }}</span>
                                @endif
                            </a>
                            <a href="{{ route("payment#orderList") }}" class="position-relative me-4 my-auto">
                                <i class="fa fa-list fa-2x"></i>
                                @if(count(session("pending_order")) > 0)
                                 <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ count(session("pending_order")) }}</span>
                                @endif
                            </a>
