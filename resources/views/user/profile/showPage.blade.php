                ...
                <div class="card-body my-4">
                    <div class="row">
                        ...
                        <div class="col offset-1">
                            ...
                            <a href="{{ route('profile#passwordChangePage') }}" class="btn btn-sm btn-warning my-3 mr-1">
                                Change Password
                            </a>
                            <a href="{{ route('profile#editUser') }}" class="btn btn-sm btn-danger my-3 mr-1">Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>
